...
func (ec *executionContext) field_Mutation_upsertCharacter_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCharacterInput2userᚋgraphᚋmodelᚐCharacterInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_characters_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["cliqueType"]; ok {
		...
		arg0, err = ec.unmarshalNCliqueType2userᚋgraphᚋmodelᚐCliqueType(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Character_cliqueType(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCliqueType2userᚋgraphᚋmodelᚐCliqueType(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_upsertCharacter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCharacter2ᚖuserᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_character(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚖuserᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_characters(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚕᚖuserᚋgraphᚋmodelᚐCharacterᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCharacterInput(ctx context.Context, obj interface{}) (model.CharacterInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "cliqueType":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("cliqueType"))
			it.CliqueType, err = ec.unmarshalNCliqueType2userᚋgraphᚋmodelᚐCliqueType(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNCharacter2userᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v model.Character) graphql.Marshaler {
	return ec._Character(ctx, sel, &v)
}

func (ec *executionContext) marshalNCharacter2ᚖuserᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNCharacterInput2userᚋgraphᚋmodelᚐCharacterInput(ctx context.Context, v interface{}) (model.CharacterInput, error) {
	res, err := ec.unmarshalInputCharacterInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNCliqueType2userᚋgraphᚋmodelᚐCliqueType(ctx context.Context, v interface{}) (model.CliqueType, error) {
	var res model.CliqueType
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCliqueType2userᚋgraphᚋmodelᚐCliqueType(ctx context.Context, sel ast.SelectionSet, v model.CliqueType) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalOCharacter2ᚕᚖuserᚋgraphᚋmodelᚐCharacterᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCharacter2ᚖuserᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOCharacter2ᚖuserᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Character(ctx, sel, v)
