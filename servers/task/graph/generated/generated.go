...
type ComplexityRoot struct {
	...
	Mutation struct {
		UpsertTask func(childComplexity int, input model.TaskInput) int
	}
...
type MutationResolver interface {
	UpsertTask(ctx context.Context, input model.TaskInput) (*model.Task, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.upsertTask":
		...
		return e.complexity.Mutation.UpsertTask(childComplexity, args["input"].(model.TaskInput)), true
...
func (ec *executionContext) field_Mutation_upsertTask_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNTaskInput2taskᚋgraphᚋmodelᚐTaskInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_upsertTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpsertTask(rctx, fc.Args["input"].(model.TaskInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNTask2ᚖtaskᚋgraphᚋmodelᚐTask(ctx, field.Selections, res)
}
...
func (ec *executionContext) _User_tasks(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Task)
	fc.Result = res
	return ec.marshalOTask2ᚕᚖtaskᚋgraphᚋmodelᚐTask(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNTask2taskᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v model.Task) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNTaskInput2taskᚋgraphᚋmodelᚐTaskInput(ctx context.Context, v interface{}) (model.TaskInput, error) {
...
func (ec *executionContext) marshalOTask2ᚕᚖtaskᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v []*model.Task) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOTask2ᚖtaskᚋgraphᚋmodelᚐTask(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOTask2ᚖtaskᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Task(ctx, sel, v)
